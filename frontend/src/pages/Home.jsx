...
// Expanded Mock Data
const MOCK_BOOKS = [
  { id: 1, title: 'The Pragmatic Programmer', author: 'David Thomas', genre: 'Tech', language: 'English', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780135957059-M.jpg', isTrending: true, isRecommended: false, isComingSoon: false },
  { id: 2, title: 'Clean Code', author: 'Robert C. Martin', genre: 'Tech', language: 'English', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780132350884-M.jpg', isTrending: true, isRecommended: true, isComingSoon: false },
  { id: 3, title: 'Dune', author: 'Frank Herbert', genre: 'Fiction', language: 'English', ageGroup: 'Young Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780441172719-M.jpg', isTrending: true, isRecommended: true, isComingSoon: false },
  { id: 4, title: 'Godan', author: 'Munshi Premchand', genre: 'Classic', language: 'Hindi', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9788188440053-M.jpg', isTrending: false, isRecommended: true, isComingSoon: false },
  { id: 5, title: 'Atomic Habits', author: 'James Clear', genre: 'Self-Help', language: 'English', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780735211292-M.jpg', isTrending: true, isRecommended: true, isComingSoon: false },
  { id: 6, title: 'Yayati', author: 'V. S. Khandekar', genre: 'Mythology', language: 'Marathi', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9788177665245-M.jpg', isTrending: false, isRecommended: true, isComingSoon: false },
  { id: 7, title: 'Project Hail Mary', author: 'Andy Weir', genre: 'Fiction', language: 'English', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780593135204-M.jpg', isTrending: true, isRecommended: false, isComingSoon: false },
  { id: 8, title: 'Deep Work', author: 'Cal Newport', genre: 'Business', language: 'English', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9781455586691-M.jpg', isTrending: false, isRecommended: true, isComingSoon: false },
  { id: 9, title: 'The Winds of Winter', author: 'George R.R. Martin', genre: 'Fiction', language: 'English', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780002247412-M.jpg', isTrending: false, isRecommended: false, isComingSoon: true },
  { id: 10, title: 'Madhushala', author: 'Harivansh Rai Bachchan', genre: 'Poetry', language: 'Hindi', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9788121601053-M.jpg', isTrending: true, isRecommended: true, isComingSoon: false },
  { id: 11, title: 'Diary of a Wimpy Kid', author: 'Jeff Kinney', genre: 'Fiction', language: 'English', ageGroup: '9-12 Years', cover: 'https://covers.openlibrary.org/b/isbn/9780141324906-M.jpg', isTrending: true, isRecommended: false, isComingSoon: false },
  { id: 12, title: 'The Very Hungry Caterpillar', author: 'Eric Carle', genre: 'Fiction', language: 'English', ageGroup: '0-5 Years', cover: 'https://covers.openlibrary.org/b/isbn/9780241003008-M.jpg', isTrending: false, isRecommended: true, isComingSoon: false },
  { id: 13, title: 'Introduction to Algorithms', author: 'Thomas H. Cormen', genre: 'Tech', language: 'English', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780262033848-M.jpg', isTrending: false, isRecommended: true, isComingSoon: false },
  { id: 14, title: 'Sapiens', author: 'Yuval Noah Harari', genre: 'History', language: 'English', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780062316097-M.jpg', isTrending: true, isRecommended: true, isComingSoon: false },
  { id: 15, title: '1984', author: 'George Orwell', genre: 'Classic', language: 'English', ageGroup: 'Young Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780451524935-M.jpg', isTrending: false, isRecommended: true, isComingSoon: false },
  { id: 16, title: 'Harry Potter and the Cursed Child', author: 'J.K. Rowling', genre: 'Fiction', language: 'English', ageGroup: '9-12 Years', cover: 'https://covers.openlibrary.org/b/isbn/9781338099133-M.jpg', isTrending: true, isRecommended: false, isComingSoon: false },
  { id: 17, title: 'The Midnight Library', author: 'Matt Haig', genre: 'Fiction', language: 'English', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780525559474-M.jpg', isTrending: true, isRecommended: true, isComingSoon: false },
  { id: 18, title: 'Book Lovers', author: 'Emily Henry', genre: 'Fiction', language: 'English', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780593440872-M.jpg', isTrending: false, isRecommended: false, isComingSoon: true },
  { id: 19, title: 'Tomorrow, and Tomorrow, and Tomorrow', author: 'Gabrielle Zevin', genre: 'Fiction', language: 'English', ageGroup: 'Adult', cover: 'https://covers.openlibrary.org/b/isbn/9780593321201-M.jpg', isTrending: false, isRecommended: false, isComingSoon: true },
  { id: 20, title: 'Iron Flame', author: 'Lauren Roberts', genre: 'Fiction', language: 'English', ageGroup: 'Young Adult', cover: 'https://covers.openlibrary.org/b/isbn/9781649374172-M.jpg', isTrending: false, isRecommended: false, isComingSoon: true },
];
      ...
      <div className="position-relative group">
        ...
        <div ref={scrollRef} className="d-flex align-items-end gap-4 px-4 hide-scrollbar" style={{ overflowX: 'auto', paddingBottom: '2px' }}>
          {books.map((book) => {
            ...
            return (
              <div key={book.id} className="position-relative flex-shrink-0" style={{ width: '115px', cursor: 'pointer' }} onClick={() => inCart ? removeFromCart(book.id) : addToCart(book)}>
        ...
        <button onClick={() => scroll('right')} className="btn position-absolute top-50 translate-middle-y rounded-circle shadow-sm d-flex align-items-center justify-content-center" style={{ right: '-15px', width: '36px', height: '36px', backgroundColor: COLORS.white, color: COLORS.textPrimary, zIndex: 10, border: 'none' }}><ChevronRight size={20} /></button>
